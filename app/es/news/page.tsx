...
export const metadata = {
  title: 'Noticias de Vigilancia - Activist Checklist',
  description: 'Últimas noticias sobre vigilancia estatal y amenazas a los movimientos sociales.',
};
...
export default async function NewsPage() {
  const newsItems = getAllNewsItems('es').map((item) => toNewsListItem(item));
