...
export const metadata = {
  title: 'Actualizaciones del Sitio - Activist Checklist',
  description: 'Historial completo de actualizaciones y mejoras a las guías de seguridad digital de Activist Checklist.',
  alternates: {
    types: {
