...
*Note:* If you find this process very annoying and cumbersome (because it is!), that's another good reason to use a [secondary phone](/secondary/) for actions. That phone would only ever be in the one or two groups needed to pull off the action that day.
