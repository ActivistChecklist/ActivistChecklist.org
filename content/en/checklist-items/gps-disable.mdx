...
Cops use various kinds of [warrantless location-tracking tools](https://www.404media.co/inside-ices-tool-to-monitor-phones-in-entire-neighborhoods/) to surveil activists.
