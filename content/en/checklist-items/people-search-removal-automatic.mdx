---
title: >-
  Remove yourself from “people search” sites using an automated service (like
  EasyOptOuts)
preview: >
  Using a tool to automatically remove yourself from all these sites saves a lot
  of time.
do: >
  Sign up for [EasyOptOuts](https://easyoptouts.com/) ($20/year) — or [Optery
  Ultimate](https://www.optery.com/) ($249/year) for more coverage
dont: |
  We don't recommend DeleteMe because it's less effective than EasyOptOuts
titleBadges:
  - important
