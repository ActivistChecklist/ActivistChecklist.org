...
type: checkbox
why: Minimize tracking, so there’s less of a digital trail.
tools: "Use [Brave Browser](https://brave.com/) (easiest) or [Firefox](https://www.mozilla.org/en-US/firefox/) (more setup required)"
stop: Use Google Chrome, Microsoft Edge, etc.
---
