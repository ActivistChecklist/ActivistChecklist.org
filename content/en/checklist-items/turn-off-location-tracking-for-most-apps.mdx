...
slug: turn-off-location-tracking-for-most-apps
type: checkbox
why: Protect yourself from apps with location access giving the government or data brokers a detailed log of your movements
tools: Turn off location tracking for most apps
stop: Let every app know where you are
---
