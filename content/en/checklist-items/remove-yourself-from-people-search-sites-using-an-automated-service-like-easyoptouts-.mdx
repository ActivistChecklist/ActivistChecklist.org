...
type: checkbox
why: Using a tool to automatically remove yourself from all these sites saves a lot of time.
tools: "Sign up for [EasyOptOuts](https://easyoptouts.com/) ($20/year) — or [Optery Ultimate](https://www.optery.com/) ($249/year) for more coverage"
stop: "We don't recommend DeleteMe because it's less effective than EasyOptOuts"
titleBadges:
  - important
---
