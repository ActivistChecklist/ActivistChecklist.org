...
slug: configure-signal-to-be-as-secure-as-possible
preview: Hide your real name, real photo, message previews, and set a username
---
...
The list below captures the most important steps. For more detailed instructions and advanced stepsd, read our full [Signal Security Checklist →](/signal)
