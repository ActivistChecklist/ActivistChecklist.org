---
title: >-
  Revoke location permissions from individual apps that don't need it (which is
  most of them)
preview: >
  Protect yourself from apps with location access giving the government or data
  brokers a detailed log of your movements
do: |
  Turn off location tracking for most apps
dont: |
  Let every app know where you are
titleBadges: []
