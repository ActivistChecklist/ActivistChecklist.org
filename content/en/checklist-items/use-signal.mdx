...
preview: >
  If you use unencrypted channels, your texts and calls can be spied on by
  corporations and law enforcement (with or without a warrant).
do: |
  Use signal for texts/calls
dont: |
  Use normal texts, calls, WhatsApp, Telegram
titleBadges: []
---
<HowTo title="How to set up">
  ...
  2. Make sure you’ve set a **username** (ex: @cloudy.52). Share this with people you want to connect with rather than your phone number.
