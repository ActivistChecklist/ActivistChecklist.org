...
<Alert type="info">
  **Using Signal securely:** This article is about whether Signal is trustworthy. For concrete steps to configure the app, use our [Signal Security Checklist](/signal/).
</Alert>
...
On newer iPhones, **Apple Intelligence** (and notification summaries) is a separate issue from whether Signal's encryption is sound. See [Is Apple Intelligence reading my Signal messages?](/signal-ai/).

We recommend you follow our [Signal Security Checklist](/signal/) and [Essentials Checklist](/essentials/) to help keep your Signal messages safe once they arrive on your device.

<Button title="Signal Security Checklist →" href="/signal/" target="_self" size="lg" />
