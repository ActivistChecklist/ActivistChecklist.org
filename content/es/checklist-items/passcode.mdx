...
do: |
  Use a [random passcode generator](https://strongphrase.net/passcode) to create an 8 to 10-digit code
dont: |
  Use any passcode you thought of yourself (dates, patterns on the keyboard, etc.). Do not use 6-digit passcodes if possible.
titleBadges: []
