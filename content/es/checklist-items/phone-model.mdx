...
If you have a Google Pixel 6 or newer, we highly recommend installing [Graphene OS](https://grapheneos.org/), which is a de-Googled version of Android OS that is incredibly secure and hard for the cops to break.

As of October 2025, these are the models we know are more resistant to cracking and data extraction.

**Using an old phone someone has laying around**

* If you already have an old phone laying around or know someone who does, that’s a good option.
...
* The older the phone, the more vulnerable it is likely to be to the cracking/extraction tools cops use (like Cellebrite and Graykey)
