...
do: |
  Install a trusted VPN and keep it on. We recommend [Mullvad VPN](https://mullvad.net/en) ($5/mo) or [IVPN](https://www.ivpn.net/) ($6/mo).
dont: |
  Use a random VPN you find online. Nord VPN, Surfshark, ExpressVPN, etc. are popular but not as trustworthy.
titleBadges: []
