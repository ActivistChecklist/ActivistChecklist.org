...
<HowTo title="How to build supportive relationships with neighbors">
  ...
  6. Consider starting a **neighborhood Signal/WhatsApp group** so it’s easy for everyone to share resources and invitations. (WhatsApp is less private than Signal but is more likely to be familiar to more folks).
