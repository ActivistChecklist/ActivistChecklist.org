...
preview: |
  If you have a call through an app that isn’t end-to-end encrypted, it’s possible for it to be intercepted either by the app itself or by the government.
do: |
  Use Signal for secure group video/audio calls
dont: |
  Use Jitsi Meet. Avoid using Zoom when possible.
titleBadges: []
---
