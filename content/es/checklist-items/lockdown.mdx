...
* **Device won't connect to any WiFi automatically** - On Lockdown Mode your phone won't connect to insecure Wi-Fi networks automatically and you will need to manually connect to the chosen network and accept the security risk.
